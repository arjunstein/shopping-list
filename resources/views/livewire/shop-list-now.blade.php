<div>
    <div x-data="{ selectedItems: $wire.entangle('selectedItems').live }" x-init="() => {
        ...
        $wire.selectedItems = selectedItems;
    }">
        ...
        <div x-cloak x-show="$wire.showModalConfirmDone" x-transition
            ...
            <div class="bg-white rounded-lg shadow dark:bg-gray-700 w-full max-w-md">
                ...
                <div class="px-4 py-3 border-b dark:border-gray-600">
                    <h3 class="flex items-center justify-center text-lg font-semibold text-blue-600 dark:text-blue-400">
