    ...
    <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
        ...
        <form wire:submit.prevent="saveItem" class="mt-4">
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    <label for="item_name"
                        class="block text-sm font-medium text-gray-700 dark:text-gray-200">Item name</label>
                ...
                <div>
                    <label for="category_id"
                        class="block text-sm font-medium text-gray-700 dark:text-gray-200">Category item</label>
