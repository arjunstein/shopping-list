@once
    @if (session('success'))
        <div x-cloak x-data="{ show: true }" x-init="setTimeout(() => show = false, 3000)" x-show="show" x-transition
           ...
           dark:border-gray-600 dark:bg-gray-800">
            <div class="flex items-start gap-4">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    ...
                    <path stroke-linecap="round" stroke-linejoin="round"
                        d="M12 9v3m0 4.5h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <div class="flex-1">
                    <strong class="font-medium text-gray-900 dark:text-white">Error</strong>
                    <p class="mt-0.5 text-sm text-gray-700 dark:text-gray-300" x-text="message"></p>
                </div>
